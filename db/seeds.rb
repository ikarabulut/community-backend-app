...
# 2000.times do
#   Rsvp.create!([
#     {user_id: Random.rand(1..1000) , event_id: Random.rand(1..100), rsvp_type: ["Going", "Maybe", "No"].sample}
#   ])
# end
# 
# 20.times do
#    Cause.create!([
#     {cause: Faker::Hipster.word , archived: false}
#   ])
# end
# 
# 750.times do
#    GroupCause.create!([
#     {group_id: Random.rand(1..500) , cause_id: Random.rand(1..20)}
#   ])
# end
